...
public:
  Cmd_Atr (Var *z, Exp *p1) : Cmd(CT_ATR) { v1 = z; x1 = p1; semantic_analysis(); }
  bool semantic_analysis();
};
class Cmd_Seq : public Cmd {
public:
  Cmd_Seq (Cmd *r1, Cmd *r2) : Cmd(CT_SEQ) { c1 = r1; c2 = r2; semantic_analysis(); } 
  bool semantic_analysis();
};
class Cmd_Print : public Cmd {
public:
  Cmd_Print (Lst *ls) : Cmd(CT_PRINT) { lst = ls; semantic_analysis(); }
  bool semantic_analysis();
};
class Cmd_While : public Cmd {
public:
  Cmd_While (Exp *p1, Cmd *r1) : Cmd(CT_WHILE) { x1 = p1; c1 = r1; semantic_analysis(); }
  bool semantic_analysis();
};
class Cmd_If : public Cmd {
public:
  Cmd_If (Exp *p1, Cmd *r1) : Cmd(CT_IF) { x1 = p1; c1 = r1; el = NULL; semantic_analysis(); }
  Cmd_If (Exp *p1, Cmd *r1, ElseIf *ei) : Cmd(CT_IF) { x1 = p1; c1 = r1; el = ei; semantic_analysis(); } 
  Cmd_If (Exp *p1, Cmd *r1, ElseIf *ei, Cmd *r2) : Cmd(CT_IF) { x1 = p1; c1 = r1; el = ei; c2 = r2; semantic_analysis(); }
  bool semantic_analysis();
};
