...
enum TC_OP { TC_PRINT, TC_PRINT_ENDL, TC_ADD, TC_SUB, TC_MUL, TC_DIV, TC_POW, TC_MOD, TC_MIN, TC_AND, TC_OR, TC_EQ, TC_NEQ, TC_LT, TC_GT, TC_LEQ, TC_GEQ, TC_NOT, TC_ATR, TC_LBL, TC_GOTO, TC_IFEQ, TC_IFNEQ, TC_IFLT, TC_IFGT, TC_IFLEQ, TC_IFGEQ, TC_LOAD, TC_IN_SCOPE, TC_OUT_SCOPE, TC_FIN_SCOPE, TC_FOUT_SCOPE };
class Tac {
public:
  TC_OP op;
  Addr *r1, *r2, *r3;
